    ...
    return (
        <HydrationBoundary state={dehydrate(query)}>
            <div className='flex h-screen md:pt-5'>
                ...
                <div className='md:ml-[300px] flex-col flex-1 bg-[#101011] md:rounded-tl-xl overflow-y-auto border-l-[1px] border-t-[1px] border-[#28282D]'>
                    <Navbar groupid={groupid} userid={user.id}/>  {/* ✅ Fixed: use groupid */}
                    {children}
                </div>
            </div>
        </HydrationBoundary>
